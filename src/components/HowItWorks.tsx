    ...
    <div className="w-full max-w-4xl rounded-2xl bg-white p-8 shadow-md flex flex-col gap-6">
      <div className="flex flex-col gap-5 text-base">
        <StepRow step={1}>
          ...
          <HelpTooltip>
            Si vous ne trouvez pas le fichier, demandez aux resps précédent·e·s où il se trouve.
          </HelpTooltip>
        </StepRow>
        ...
        <StepRow step={3}>
          ...
          <HelpTooltip>
            Par exemple, vous pouvez commencer par mettre à jour les rôles des nouveaux/nouvelles resps, et du trésorier s'il y en a un.<br />
            Ensuite, vous pouvez rajouter leurs bizs aux gens qui en ont.<br />
            N'oubliez pas de rajouter les gens qui ont été rachetés dans la miff en cours d'année, et les bizs qui n'ont pas de parrain ni de marraine !
          </HelpTooltip>
          <br />
        ...
        <StepRow step={5}>
          ...
          <HelpTooltip>
            Pensez aux resps de l'année prochaine ! Ils et elles auront besoin de repartir de là où vous vous êtes arrêté·e·s.
          </HelpTooltip>
        </StepRow>
